...
// Click To Call
 $(document).ready(function() {
 	...
 	$("#cl2call").click(function() {
 		...
 		if (teleduce_mobile == ""){
				$("#cl2call_form_error").attr("style","").html("Please enter <strong>Mobile number</strong>");
				$("#cl2call_form_error").show();
				$('#cl2call_mobile').focus().attr("style","border-color:red");
				$(window).scrollTop($('#cl2call_form_error').offset().top);
				return false;
        }
        else{
            if (!IsMobileNumber(teleduce_mobile)){
                $("#cl2call_form_error").attr("style","").html("Please enter valid <strong>Mobile number</strong>");
                $("#cl2call_form_error").show();
                $('#cl2call_mobile').focus().attr("style","border-color:red");
                $(window).scrollTop($('#cl2call_form_error').offset().top);
                return false;
        ...
        //     }
        // }
        call_latch_url = 'https://teleduce.in/calllatch/partha/partha/'+teleduce_mobile+'/9036164750/8067335515/?async=true';
 		...
 		try {
                ...
                ajaxRequest.onreadystatechange = function(){
                    if (ajaxRequest.readyState == 4) {
                        ...
                        $("#cl2call_form_success").attr("style","").html("Call Triggered Successfully");
